...
{% block title %}{{ tr('update_feature') | upper }} {{ feature.feature_id }}{% endblock %}
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-10 col-md-offset-1 animate-box">
          <h2>
            <strong>{{ tr('update_feature') }} {{ feature.feature_id }}</strong>
            <br>
            <a href="{{ url('caracteristicas/administrar') }}" class="btn-warning btn-xs">
              <i class="fa fa-arrow-left"></i> {{ tr('form_back') }}
            </a>
          </h2>
          {{ form('caracteristicas/actualizar/' ~ feature.feature_id, 'method': 'post', 'enctype': 'multipart/form-data', 'id': 'frm') }}
            <div class="row form-group">
              <div class="col-md-12">
                <label for="titulo">{{ tr('feature_title') }}</label>
                <input type="text" name="titulo" value="{{ old.titulo is defined ? old.titulo : feature.title }}" class="form-control frm-id">
              </div>
            </div>
            <div class="row form-group">
              <div class="col-md-12">
                <label for="contenido">{{ tr('feature_content') }}</label>
                <input type="text" name="contenido" value="{{ old.contenido is defined ? old.contenido : feature.content }}" class="form-control frm-id">
              </div>
            </div>
            <div class="row form-group">
              <div class="col-md-12">
            ...
            <div class="row form-group">
              <div class="col-md-12">
                <label for="icono">{{ tr('feature_image') }}</label>
