...
{% block title %}{{ tr('update_password_title') | upper }}{% endblock %}
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-10 col-md-offset-1 animate-box">
          <h2>
            <strong>{{ tr('update_password_title') }}</strong>
            <br>
          ...
          {{ form('perfil/actualizar-contrasenia', 'method': 'post', 'id': 'frm') }}
            <div class="row form-group">
              <div class="col-md-8">
                <label for="contrasenia">{{ tr('upd_password_current_password') }}</label>
                <input type="password" name="contrasenia" class="form-control">
              </div>
            </div>
            <div class="row form-group">
              <div class="col-md-8">
                <label for="repetir_contrasenia">{{ tr('upd_password_confirm_password') }}</label>
