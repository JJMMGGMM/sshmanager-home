...
{% block title %}{{ tr('register_title') | upper }}{% endblock %}
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-10 col-md-offset-1 animate-box">
          <h2>
            <strong>{{ tr('register_title') }}</strong>
          </h2>
          {{ form('404/perfil/registro', 'method': 'post', 'id': 'frm') }}
            <div class="row form-group">
              <div class="col-md-8">
                <label for="alias">{{ tr('register_alias') }}</label>
                <input type="text" name="alias" class="form-control" placeholder="{{ tr('register_alias') }}" value="{{ old.alias is defined ? old.alias : '' }}">
              </div>
            </div>
            <div class="row form-group">
              <div class="col-md-8">
                <label for="correo">{{ tr('register_email') }}</label>
                <input type="text" name="correo" class="form-control" placeholder="{{ tr('register_email') }}"  value="{{ old.correo is defined ? old.correo : '' }}">
              </div>
            </div>
            <div class="row form-group">
              <div class="col-md-8">
                <label for="contrasenia">{{ tr('register_password') }}</label>
                <input type="password" name="contrasenia" class="form-control" placeholder="{{ tr('register_password') }}">
              </div>
            </div>
            <div class="row form-group">
              <div class="col-md-8">
                <label for="repetir_contrasenia">{{ tr('register_repeat_password') }}</label>
                <input type="password" id="repetir_contrasenia" name="repetir_contrasenia" class="form-control" placeholder="{{ tr('register_repeat_password') }}">
              </div>
            </div>
            <div class="row form-group">
              <div class="col-md-4">
                <label for="captcha">{{ tr('register_captcha') }}</label>
                <input type="text" name="captcha" class="form-control" placeholder="Captcha" placeholder="{{ tr('register_captcha') }}">
              </div>
            </div>
