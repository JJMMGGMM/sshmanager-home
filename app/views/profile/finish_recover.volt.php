...
{% block title %}{{ tr('finish_recover_profile_title') | upper }}{% endblock %}
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-10 col-md-offset-1 animate-box">
          <h2>
            <strong>{{ tr('finish_recover_profile_title') }}</strong>
          </h2>
          {{ form('404/perfil/recuperar/finalizar/' ~ admin_id ~ '/' ~ token, 'method': 'post', 'id': 'frm') }}
            <div class="row form-group">
              <div class="col-md-8">
                <label for="contrasenia">{{ tr('f_rcv_prf_password_new_password') }}</label>
                <input type="password" name="contrasenia" class="form-control">
              </div>
            </div>
            <div class="row form-group">
              <div class="col-md-8">
                <label for="repetir_contrasenia">{{ tr('f_rcv_prf_password_confirm_password') }}</label>
            ...
            <div class="row form-group">
              <div class="col-md-4">
                ...
                <input type="text" id="captcha" name="captcha" class="form-control frm-id">
              </div>
            </div>
