...
{% block title %}{{ tr('update_alias_title') | upper }}{% endblock %}
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-10 col-md-offset-1 animate-box">
          <h2>
            <strong>{{ tr('update_alias_title') }}</strong>
            <br>
          ...
          {{ form('perfil/actualizar-alias', 'method': 'post', 'id': 'frm') }}
            <div class="row form-group">
              <div class="col-md-8">
                <label for="alias">{{ tr('upd_alias_new_alias') }}</label>
                <input type="text" name="alias" value="{{ old.alias is defined ? old.alias : admin.alias }}" class="form-control frm-id">
              </div>
            </div>
