...
{% block title %}{{ tr('delete_profile_title') | upper }}{% endblock %}
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-10 col-md-offset-1 animate-box">
          <h2>
            <strong>{{ tr('delete_profile_title') }}</strong>
            <br>
            <small>
          ...
          {{ form('perfil/borrar', 'method': 'post', 'id': 'frm') }}
            <div class="row form-group">
              <div class="col-md-8">
                <label for="contrasenia">{{ tr('del_pfr_email_current_password') }}</label>
                <input type="password" name="contrasenia" class="form-control">
              </div>
            </div>
            <div class="row form-group">
              <div class="col-md-8">
                <label for="repetir_contrasenia">{{ tr('del_prf_email_confirm_password') }}</label>
