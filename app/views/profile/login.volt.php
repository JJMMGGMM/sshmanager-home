...
{% block title %}{{ tr('login_title') | upper }}{% endblock %}
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-10 col-md-offset-1 animate-box">
          <h2>
            <strong>{{ tr('login_title') }}</strong>
          </h2>
          {{ form('404/perfil/ingreso', 'method': 'post', 'id': 'frm') }}
            <div class="row form-group">
              <div class="col-md-8">
                <label for="correo">{{ tr('login_email') }}</label>
                <input type="text" id="correo" name="correo" class="form-control frm-id" placeholder="{{ tr('login_email') }}" value="{{ old.correo is defined ? old.correo : '' }}">
              </div>
            </div>
            <div class="row form-group">
              <div class="col-md-8">
                <label for="contrasenia">{{ tr('login_password') }}</label>
                <input type="password" id="contrasenia" name="contrasenia" class="form-control frm-id" placeholder="{{ tr('login_password') }}">
              </div>
            </div>
            <div class="row form-group">
              <div class="col-md-4">
