...
{% block title %}{{ tr('update_contact_page') | upper }}{% endblock %}
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-10 col-md-offset-1 animate-box">
          <h2>
            <strong>{{ tr('update_contact') }}</strong>
            <br>
            <a href="{{ url('contacto/reiniciar') }}" class="btn-danger btn-xs">
              {{ tr('form_restart_page') }}
            </a>
          </h2>
          {{ form('contacto/previsualizar', 'method': 'post', 'id': 'frm') }}
