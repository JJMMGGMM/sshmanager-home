...
{% block title %}{{ tr('contact_title') | upper }}{% endblock %}
        ...
        <div class="col-md-10 col-md-offset-1 animate-box">
          ...
          <form id="frm">
            <div class="row form-group">
              <div class="col-md-8">
                <label for="nombre">{{ tr('contact_name') }}</label>
                <input type="text" id="nombre" class="form-control frm-id" placeholder="{{ tr('contact_name') }}">
              </div>
            </div>
            <div class="row form-group">
              <div class="col-md-8">
                <label for="nombre">{{ tr('contact_email') }}</label>
                <input type="text" id="correo" class="form-control frm-id" placeholder="{{ tr('contact_email') }}">
              </div>
            </div>
            <div class="row form-group">
              <div class="col-md-8">
                <label for="asunto">{{ tr('contact_subject') }}</label>
                <input type="text" id="asunto" class="form-control frm-id" placeholder="{{ tr('contact_subject') }}">
              </div>
            </div>
            <div class="row form-group">
              <div class="col-md-8">
                <label for="mensaje">{{ tr('contact_message') }}</label>
                <textarea id="mensaje" class="form-control frm-id" cols="30" rows="10" placeholder="{{ tr('contact_message') }}"></textarea>
              </div>
            </div>
            <div class="row form-group">
              <div class="col-md-4">
                <label for="nombre">{{ tr('contact_captcha') }}</label>
                <input type="text" id="captcha" class="form-control frm-id" placeholder="{{ tr('contact_captcha') }}">
              </div>
            </div>
            <div class="row form-group">
              <div class="col-md-4">
  ...
  <script type="text/javascript">
    (function() {
      ...
      btn_submit_frm.addEventListener('click', function prepareData(event) {
        ...
        route = '{{ url("contacto/enviar-datos") }}';
        method = 'post';
        data = {};
