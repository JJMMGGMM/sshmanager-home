...
{% block title %}{{ tr('all_faqs') | upper }}{% endblock %}
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-10 col-md-offset-1 animate-box">
          <h2>
            <strong>{{ tr('update_faqs') }}</strong>
            <br>
            <a href="{{ url('preguntas-frecuentes/reiniciar') }}" class="btn-danger btn-xs">
              {{ tr('form_restart_page') }}
            </a>
          </h2>
          {{ form('preguntas-frecuentes/previsualizar', 'method': 'post', 'id': 'frm') }}
            <div class="row form-group">
              <div class="col-md-12">
                <label for="contenido">{{ tr('faq_content') }}</label>
                <textarea name="contenido" class="form-control frm-id" cols="30" rows="10" id="content">{{ md_content }}</textarea>
              </div>
            </div>
