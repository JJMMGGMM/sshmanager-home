...
getConfig(){
    config_file="config_console.txt"
...
banner(){
    clear
    echo ""
    echo "manager.sh - Versión ${VERSION}"
    echo "autor: ${AUTOR}"
    echo ""
    echo "                                                   [SSH] "
    echo ""
    echo "                        1OO ik@L .qO1   L@BP88qB ;ZB L@q   "
    echo "                       B@B7u@BOLUB@B  B@B, qB@X .@@Z@BM  "
    echo "                      .@BE 7B@k  @B5  @Bu  B@@  U@@Y    "
    echo "                      @B@  B@M  BB@   :BurO@P   @BE   "
    echo "                     iB@: 0@B  YB@F7 L@ML7     MB@   "
    echo "                     0@M  @Bq  r@Bq  uB@B@B@U  B@X   "
    echo "                                    @B   .@B@         "
    echo "                                    P@Orr000         "
    echo ""
}
